                    ...
                    <body>
                        ...
                        <div id="theme-guide">
                            ...
                            <svg viewbox="0 0 1500 120">
                                <text x="750" y="30" font-size="30" fill="#FFFFFF" text-anchor="middle">Color Guide for Themes</text>
                                <circle cx="190" cy="60" r="20" fill="#340058" stroke="black"/>
                                <text x="190" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Guilt</text>
                                <circle cx="250" cy="60" r="20" fill="#49EB96" stroke="black"/>
                                <text x="250" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Isolation</text>
                                <circle cx="315" cy="60" r="20" fill="#6B0001" stroke="black"/>
                                <text x="315" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Ambition</text>
                                <circle cx="380" cy="60" r="20" fill="#FF3103" stroke="black"/>
                                <text x="380" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Madness</text>
                                <circle cx="445" cy="60" r="20" fill="#717070" stroke="black"/>
                                <text x="445" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Secrecy</text>
                                <circle cx="570" cy="60" r="20" fill="#007A2B" stroke="black"/>
                                <text x="570" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Consequences Of Creation</text>
                                <circle cx="695" cy="60" r="20" fill="#FE9900" stroke="black"/>
                                <text x="695" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Obsession</text>
                                <circle cx="755" cy="60" r="20" fill="#059FFF" stroke="black"/>
                                <text x="755" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Worry</text>
                                <circle cx="815" cy="60" r="20" fill="#28FF07" stroke="black"/>
                                <text x="815" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Self Disgust</text>
                                <circle cx="890" cy="60" r="20" fill="#FF0303" stroke="black"/>
                                <text x="890" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Rage</text>
                                <circle cx="945" cy="60" r="20" fill="#814B00" stroke="black"/>
                                <text x="945" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Misery</text>
                                <circle cx="995" cy="60" r="20" fill="#739501" stroke="black"/>
                                <text x="995" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Illness</text>
                                <circle cx="1055" cy="60" r="20" fill="#FFFFFF" stroke="black"/>
                                <text x="1055" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Death</text>
                                <circle cx="1115" cy="60" r="20" fill="#FF0389" stroke="black"/>
                                <text x="1115" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Depression</text>
                                <circle cx="1175" cy="60" r="20" fill="#A00155" stroke="black"/>
                                <text x="1175" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Fear</text>
                                <circle cx="1235" cy="60" r="20" fill="#EAE010" stroke="black"/>
                                <text x="1235" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Places</text>
                                <circle cx="1295" cy="60" r="20" fill="#3411FF" stroke="black"/>
                                <text x="1295" y="95" font-size="15" fill="#FFFFFF" text-anchor="middle">Characters</text>
                            </svg>
                        </div>
