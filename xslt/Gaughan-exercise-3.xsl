                ...
                <body>
                    ...
                    <svg viewBox="0 0 1000 1000">
                        <g transform="translate(150,50)">
                            <xsl:for-each-group select="//ch//analysis_Word" group-by="@theme">
                                ...
                                <text x="{$xspacer * $word-count + 10}" y="{$yspacer * $word-sequence}" text-anchor="right"><xsl:value-of select="$word-count"/></text>
                                
                            </xsl:for-each-group> 
                            <line x1="0" y1="0" x2="0" y2="{count(//ch//analysis_Word) * $yspacer}" stroke="black" stroke-width="1"/>
                        </g> 
                    </svg>
                </body>
            </html>
